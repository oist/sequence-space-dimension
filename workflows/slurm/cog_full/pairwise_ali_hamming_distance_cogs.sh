...
#SBATCH --output=/flash/KondrashovU/ladaisa/logs/cogs/full/pairwise_ali.log
...
while read -r INFILE; do 
	python3 /bucket/KondrashovU/seq_space/scripts/hamming_distance_pairwise_ali_universal.py -f $INFILE -l True -d True -if $INP/sequences/ -of $OUT/muscle/pdistm_matrices_unique_pairwise_ali/ -a muscle -w 10000  &>  $OUT/cogs_pairwise_ali_dist_$SLURM_ARRAY_TASK_ID.log
