...
#SBATCH --job-name=align_gamma
#SBATCH --output=/flash/KondrashovU/ladaisa/logs/eggnoggamma/align_translated_nt/align_translated_nt_eggnog_gamma_under_200nt_1585_and_5_%A_%a.log
...
INFILE=$(head -$SLURM_ARRAY_TASK_ID $INP/list_of_lists_all_gammaproteo_eggNOGs_nt_translated_1585_and_5remaining_to_align.list  | tail -1)
