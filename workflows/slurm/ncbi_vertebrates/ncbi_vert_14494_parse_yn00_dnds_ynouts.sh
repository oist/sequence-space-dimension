...
#SBATCH --job-name=ynparse_dnds
#SBATCH --output=/flash/KondrashovU/ladaisa/logs/ncbivert/recalculate_dnds_ng86_yn00/parse_yn00_dnds14494.log
...
-f $INP/ncbi_vert_dnds_yn00_ynout.list -id $INP/ynout_dir_yn00/ -od $OUT/ncbivert/recalculate_dnds_ng86_yn00/ \
-s '_' -a 'yn00' -l 1
