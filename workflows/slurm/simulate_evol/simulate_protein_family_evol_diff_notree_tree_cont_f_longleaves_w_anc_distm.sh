...
#SBATCH --job-name=longcontF
#SBATCH --output=/flash/KondrashovU/ladaisa/logs/simulate_evol/uniform_frac/simulate_final_longcontF_%A_%a.log
...
ALLPARAMS=$(head -$SLURM_ARRAY_TASK_ID $INP/params/evol_all_tree_notree_w_epistasis_long_leaves_cont_f.list | tail -1)
