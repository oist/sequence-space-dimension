...
#SBATCH --job-name=shortcontF
#SBATCH --output=/flash/KondrashovU/ladaisa/logs/simulate_evol/uniform_frac/simulate_final_notree_normshortcontF_%A_%a.log
...
ALLPARAMS=$(head -$SLURM_ARRAY_TASK_ID $INP/params/evol_all_tree_notree_w_epistasis_normal_short_leaves_cont_f.list | tail -1)
